Rails.application.routes.draw do
  constraints subdomain: 'api' do
    ...
    resources :event_categories, only: [:update, :destroy, :show], as: "categories", path: "categories" do
      resources :rubric_categories, only: [:create, :index, :destroy], as: "rubrics", path: "rubrics"
    end
    ...
    resources :rubrics, only: [:update, :destroy, :show]
